...
namespace HoaxGames
{
    public class AddonAdaptToSurfaceSlope : MonoBehaviour
    {
        ...
        protected List<FootIK.AnimatorStateEntry> m_forceAdaptRotationToSurfaceSlopeAnimStates = new ();
        ...
        protected List<KeyValuePair<int, int>> m_adaptRotationToSurfaceSlopeAnimStates = new ();
